...
goog.exportSymbol('proto.user.UserListRes', null, global);
/**
 ...
 * @constructor
 */
proto.user.UserListRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.user.UserListRes.repeatedFields_, null);
};
goog.inherits(proto.user.UserListRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.user.UserListRes.displayName = 'proto.user.UserListRes';
}
...
proto.user.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    isactive: jspb.Message.getBooleanFieldWithDefault(msg, 44, false)
  };
 ...
 * @return {string}
 */
proto.user.User.prototype.getFamily = function() {
 ...
 * @return {!proto.user.User} returns this
 */
proto.user.User.prototype.setFamily = function(value) {
 ...
 * @const
 */
proto.user.UserListRes.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.user.UserListRes.prototype.toObject = function(opt_includeInstance) {
  return proto.user.UserListRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.user.UserListRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.UserListRes.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.user.UserListRes}
 */
proto.user.UserListRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.user.UserListRes;
  return proto.user.UserListRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.user.UserListRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.user.UserListRes}
 */
proto.user.UserListRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.user.UserListRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.user.UserListRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.user.UserListRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.UserListRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.user.UserListRes.prototype.getUserlistList = function() {
 ...
 * @return {!proto.user.UserListRes} returns this
*/
proto.user.UserListRes.prototype.setUserlistList = function(value) {
 ...
 * @return {!proto.user.User}
 */
proto.user.UserListRes.prototype.addUserlist = function(opt_value, opt_index) {
 ...
 * @return {!proto.user.UserListRes} returns this
 */
proto.user.UserListRes.prototype.clearUserlistList = function() {
